...
**Branch**: `registro-accidente` | **Date**: 2026-07-09 | **Spec**: `specs/003-operational/Emergencias/registro-accidente/backend/spec.md`

**Input**: Feature specification from `specs/003-operational/Emergencias/registro-accidente/backend/spec.md` (clarificaciones Session 2026-07-09 integradas).  
**Capa hermana (UI):** `../frontend/` — ver [`../registro-accidente.md`](../registro-accidente.md).
...
├── registro-accidente.md       # índice del módulo
...
│   └── tasks.md
└── frontend/                   # Interaction Capability (Angular)
```
...
| Artefacto | Ruta |
|-----------|------|
| Plan | `specs/003-operational/Emergencias/registro-accidente/backend/plan.md` |
| Research | `specs/003-operational/Emergencias/registro-accidente/backend/research.md` |
| Data model | `specs/003-operational/Emergencias/registro-accidente/backend/data-model.md` |
| Quickstart | `specs/003-operational/Emergencias/registro-accidente/backend/quickstart.md` |
| OpenAPI contract | `specs/003-operational/Emergencias/registro-accidente/backend/contracts/registro-accidente.openapi.yaml` |
