...
**Ubicación:** `specs/003-operational/Emergencias/despacho-inteligente/`
...
| **Frontend** | [`frontend/`](./frontend/) | **Interaction Capability (Fase B)** — monitoreo, mi-despacho, asignación | `spec.md`, `plan.md`, `tasks.md`, `contracts/*.ui-contract.md`, `quickstart.md` |
...
3. Cambiar `.specify/feature.json` → `…/despacho-inteligente/backend` o `…/frontend` según la capa en curso.

## Convención de nombres

El archivo de índice del módulo se llama **igual que la carpeta del módulo** (`despacho-inteligente.md`), no `README.md`.
