...
> **Indice del modulo:** [`../despacho-inteligente.md`](../despacho-inteligente.md).
> **UI (Interaction Capability):** [`../frontend/spec.md`](../frontend/spec.md) — stub Fase A; no duplicar OpenAPI/data-model en FE.


**Branch**: `despacho-inteligente` | **Date**: 2026-07-09 | **Spec**: `specs/003-operational/Emergencias/despacho-inteligente/backend/spec.md`

**Input**: Feature specification from `specs/003-operational/Emergencias/despacho-inteligente/backend/spec.md` (clarificaciones Session 2026-07-09 integradas).
...
```text
specs/003-operational/Emergencias/despacho-inteligente/backend/
├── plan.md
├── research.md
├── data-model.md
├── quickstart.md
