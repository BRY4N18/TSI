...
- **`evidencia-unidad`:** necesita que las unidades estén registradas en `Dim_UnidadEmergencia` y que su estado de disponibilidad esté actualizado en `Fact_HistorialEstadoUnidad`.
- Es requerido por:
