...
**Input**: Design documents from `specs/003-operational/Emergencias/despacho-inteligente/backend/`
...
- [X] T001 [Histórico-UI] Crear estructura de carpetas en `backend/apps/despacho/{views,services,consumers,jobs,tests/{api,services,repositories,consumers,unit,integration}}`, `backend/core/repositories/despacho/` y `frontend/src/app/modules/despacho/{pages,services,guards}`
...
- [X] T004 [Bridge-FE] [P] Generar tipos TypeScript desde contrato en `frontend/src/app/modules/despacho/services/models/despacho.types.ts` basado en `contracts/despacho-inteligente.openapi.yaml`
- [X] T005 [Histórico-UI] [P] Crear módulo Angular lazy stub `frontend/src/app/modules/despacho/despacho.routes.ts` y registrar en `frontend/src/app/app.routes.ts`
- [X] T006 [P] Crear matriz de trazabilidad CU/RF/CA→tasks en `specs/003-operational/Emergencias/despacho-inteligente/backend/traceability.md`
...
- [X] T007 Validar contrato OpenAPI como gate en `specs/003-operational/Emergencias/despacho-inteligente/backend/contracts/despacho-inteligente.openapi.yaml`
...
**US1 Gate**:
- [X] T039 [US1] Validar CA-DES-001, CA-DES-002, CA-DES-003 en `specs/003-operational/Emergencias/despacho-inteligente/backend/traceability.md`
...
**US2 Gate**:
- [X] T049 [US2] Validar CA-DES-004, CA-DES-005 en `specs/003-operational/Emergencias/despacho-inteligente/backend/traceability.md`
...
**US3 Gate**:
- [X] T059 [US3] Validar CA-DES-006, CA-DES-007, CA-DES-013 en `specs/003-operational/Emergencias/despacho-inteligente/backend/traceability.md`
...
**US4 Gate**:
- [X] T075 [US4] Validar CA-DES-008, CA-DES-010, CA-DES-011, CA-DES-012 en `specs/003-operational/Emergencias/despacho-inteligente/backend/traceability.md`
...
**US5 Gate**:
- [X] T080 [US5] Validar CA-DES-008 en `specs/003-operational/Emergencias/despacho-inteligente/backend/traceability.md`
...
- [X] T081 [Histórico-UI] [P] [US6] Crear test unitario frontend (marker: unit, AAA) para `despacho-api.service.spec.ts` en `frontend/src/app/modules/despacho/services/despacho-api.service.spec.ts`
- [X] T082 [Histórico-UI] [P] [US6] Crear test unitario frontend (marker: unit, AAA) para `mi-despacho-api.service.spec.ts` en `frontend/src/app/modules/despacho/services/mi-despacho-api.service.spec.ts`
- [X] T083 [Histórico-UI] [P] [US6] Crear test unitario frontend (marker: unit, AAA) para `despacho-sse.service.spec.ts` en `frontend/src/app/modules/despacho/services/despacho-sse.service.spec.ts`
- [X] T084 [Histórico-UI] [P] [US6] Crear test unitario frontend (marker: unit, AAA) para `despacho-parametros-api.service.spec.ts` en `frontend/src/app/modules/despacho/services/despacho-parametros-api.service.spec.ts`
- [X] T085 [Histórico-UI] [P] [US6] Crear test unitario frontend (marker: unit, AAA) para guards en `frontend/src/app/modules/despacho/guards/operador-despacho.guard.spec.ts`, `unidad-despacho.guard.spec.ts`, `director-tecnologico.guard.spec.ts`
- [X] T086 [Histórico-UI] [P] [US6] Crear test unitario frontend (marker: unit, AAA) para rutas lazy en `frontend/src/app/modules/despacho/despacho.routes.spec.ts`

### Implementation for User Story 6

- [X] T087 [Histórico-UI] [US6] Implementar `DespachoApiService` en `frontend/src/app/modules/despacho/services/despacho-api.service.ts`
- [X] T088 [Histórico-UI] [US6] Implementar `MiDespachoApiService` en `frontend/src/app/modules/despacho/services/mi-despacho-api.service.ts`
- [X] T089 [Histórico-UI] [US6] Implementar `DespachoSseService` (EventSource) en `frontend/src/app/modules/despacho/services/despacho-sse.service.ts`
- [X] T090 [Histórico-UI] [US6] Implementar `DespachoParametrosApiService` en `frontend/src/app/modules/despacho/services/despacho-parametros-api.service.ts`
- [X] T091 [Histórico-UI] [US6] Implementar guards en `frontend/src/app/modules/despacho/guards/operador-despacho.guard.ts`, `unidad-despacho.guard.ts`, `director-tecnologico.guard.ts`
- [X] T092 [Histórico-UI] [US6] Completar rutas lazy con guards en `frontend/src/app/modules/despacho/despacho.routes.ts`
...
- [X] T099 [P] Ejecutar y documentar escenarios A–H de `specs/003-operational/Emergencias/despacho-inteligente/backend/quickstart.md` en `specs/003-operational/Emergencias/despacho-inteligente/backend/traceability.md`
...
- [X] T101 [Histórico-UI] [P] Verificar cobertura frontend ≥80% módulo despacho con `ng test --include=**/despacho/**` (compilación verificada vía `ng build`; Karma requiere Chrome en CI)
