# Módulo: Evidencia en Sitio

**Ubicación:** `specs/003-operational/Emergencias/evidencia-unidad/`
...
| **Frontend** | [`frontend/`](./frontend/) | **Interaction Capability (Fase B)** — FR-UI, offline UX, enriquecimiento | `spec.md`, `plan.md`, `tasks.md`, `contracts/*.ui-contract.md`, `quickstart.md` |
...
3. Cambiar `.specify/feature.json` → `…/evidencia-unidad/backend` o `…/frontend` según la capa en curso.

## Convención de nombres

El archivo de índice del módulo se llama **igual que la carpeta del módulo** (`evidencia-unidad.md`), no `README.md`.
