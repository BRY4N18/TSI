...
**Input**: Design documents from `specs/003-operational/Emergencias/seguimiento-cierre-de-casos/backend/`
...
- [X] T001 [Histórico-UI] Crear estructura de carpetas en `backend/apps/seguimiento/{views,services,jobs,tests/{api,services,repositories,jobs,unit,integration}}`, `backend/core/repositories/seguimiento/` y `frontend/src/app/modules/seguimiento/{pages,services,guards,models}`
...
- [X] T004 [Bridge-FE] [P] Generar tipos TypeScript desde contrato en `frontend/src/app/modules/seguimiento/models/seguimiento.types.ts` basado en `contracts/seguimiento-cierre-de-casos.openapi.yaml`
- [X] T005 [Histórico-UI] [P] Crear módulo Angular lazy stub `frontend/src/app/modules/seguimiento/seguimiento.routes.ts` y registrar en `frontend/src/app/app.routes.ts`
- [X] T006 [P] Crear matriz de trazabilidad CU/RF/CA→tasks en `specs/003-operational/Emergencias/seguimiento-cierre-de-casos/backend/traceability.md`
...
- [X] T007 Validar contrato OpenAPI como gate en `specs/003-operational/Emergencias/seguimiento-cierre-de-casos/backend/contracts/seguimiento-cierre-de-casos.openapi.yaml`
...
**US1 Gate**:
- [X] T033 [US1] Validar CA-SEG-001, CA-SEG-003, CA-SEG-004 en `specs/003-operational/Emergencias/seguimiento-cierre-de-casos/backend/traceability.md`
...
**US2 Gate**:
- [X] T043 [US2] Validar CA-SEG-002 en `specs/003-operational/Emergencias/seguimiento-cierre-de-casos/backend/traceability.md`
...
**US3 Gate**:
- [X] T049 [US3] Validar CA-SEG-005, CA-SEG-006, CA-SEG-007 en `specs/003-operational/Emergencias/seguimiento-cierre-de-casos/backend/traceability.md`
...
**US5 Gate**:
- [X] T065 [US5] Validar CA-SEG-013, CA-SEG-014 en `specs/003-operational/Emergencias/seguimiento-cierre-de-casos/backend/traceability.md`
...
**US6 Gate**:
- [X] T078 [US6] Validar CA-SEG-008, CA-SEG-009, CA-SEG-010 en `specs/003-operational/Emergencias/seguimiento-cierre-de-casos/backend/traceability.md`
...
**US7 Gate**:
- [X] T087 [US7] Validar CA-SEG-011 en `specs/003-operational/Emergencias/seguimiento-cierre-de-casos/backend/traceability.md`
...
- [X] T088 [Histórico-UI] [P] [US8] Crear test unitario (marker: unit, AAA) para `seguimiento-api.service.ts` en `frontend/src/app/modules/seguimiento/services/seguimiento-api.service.spec.ts`
- [X] T089 [Histórico-UI] [P] [US8] Crear test unitario (marker: unit, AAA) para `mi-seguimiento-api.service.ts` en `frontend/src/app/modules/seguimiento/services/mi-seguimiento-api.service.spec.ts`
- [X] T090 [Histórico-UI] [P] [US8] Crear test unitario (marker: unit, AAA) para `seguimiento-sse.service.ts` en `frontend/src/app/modules/seguimiento/services/seguimiento-sse.service.spec.ts`
- [X] T091 [Histórico-UI] [P] [US8] Crear test unitario (marker: unit, AAA) para `expediente-cliente-api.service.ts` en `frontend/src/app/modules/seguimiento/services/expediente-cliente-api.service.spec.ts`
- [X] T092 [Histórico-UI] [P] [US8] Crear test unitario (marker: unit, AAA) para guards en `frontend/src/app/modules/seguimiento/guards/operador-seguimiento.guard.spec.ts`, `unidad-seguimiento.guard.spec.ts`, `cliente-expediente.guard.spec.ts`

### Implementation for User Story 8

- [X] T093 [Histórico-UI] [US8] Implementar `SeguimientoApiService` en `frontend/src/app/modules/seguimiento/services/seguimiento-api.service.ts`
- [X] T094 [Histórico-UI] [US8] Implementar `MiSeguimientoApiService` en `frontend/src/app/modules/seguimiento/services/mi-seguimiento-api.service.ts`
- [X] T095 [Histórico-UI] [US8] Implementar `SeguimientoSseService` (EventSource) en `frontend/src/app/modules/seguimiento/services/seguimiento-sse.service.ts`
- [X] T096 [Histórico-UI] [US8] Implementar `ExpedienteClienteApiService` en `frontend/src/app/modules/seguimiento/services/expediente-cliente-api.service.ts`
- [X] T097 [Histórico-UI] [US8] Implementar guards en `frontend/src/app/modules/seguimiento/guards/{operador-seguimiento,unidad-seguimiento,cliente-expediente}.guard.ts`
- [X] T098 [Histórico-UI] [US8] Implementar página mapa en `frontend/src/app/modules/seguimiento/pages/mapa-seguimiento/mapa-seguimiento.page.ts`
- [X] T099 [Histórico-UI] [US8] Implementar página mi-seguimiento unidad en `frontend/src/app/modules/seguimiento/pages/mi-seguimiento/mi-seguimiento.page.ts`
- [X] T100 [Histórico-UI] [US8] Implementar páginas historial/expediente en `frontend/src/app/modules/seguimiento/pages/historial-emergencias/` y `detalle-expediente/`
- [X] T101 [Histórico-UI] [US8] Completar rutas lazy y guards en `frontend/src/app/modules/seguimiento/seguimiento.routes.ts`
...
- [X] T102 [P] Ejecutar escenarios quickstart A–I en `specs/003-operational/Emergencias/seguimiento-cierre-de-casos/backend/quickstart.md` y documentar resultados
...
- [X] T105 [P] Completar matriz trazabilidad CA-SEG-001–014 en `specs/003-operational/Emergencias/seguimiento-cierre-de-casos/backend/traceability.md`
