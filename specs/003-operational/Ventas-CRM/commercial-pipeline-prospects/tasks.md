...
**Input**: Design documents from `specs/003-operational/Ventas-CRM/commercial-pipeline-prospects/`
...
- [X] T001 Crear estructura `backend/apps/ventas_crm/{views,services,tests/{api,services,repositories,unit}}`, `backend/core/repositories/ventas_crm/` y `frontend/src/app/modules/ventas-crm/{pages,services,guards,models}` según `plan.md`
...
- [X] T004 [P] Generar DTOs TypeScript desde OpenAPI en `frontend/src/app/modules/ventas-crm/models/prospectos.types.ts` basados en `contracts/commercial-pipeline-prospects.openapi.yaml`
- [X] T005 [P] Crear stub lazy `frontend/src/app/modules/ventas-crm/ventas-crm.routes.ts` y registrar en `frontend/src/app/app.routes.ts`
...
- [X] T007 Validar contrato OpenAPI como gate en `specs/003-operational/Ventas-CRM/commercial-pipeline-prospects/contracts/commercial-pipeline-prospects.openapi.yaml`
...
- [X] T053 [P] [US7] Implementar guards `gerente-ventas.guard.ts`, `gerente-cuentas-publicas.guard.ts`, `admin-o-gerente-crm.guard.ts` en `frontend/src/app/modules/ventas-crm/guards/`
- [X] T054 [P] [US7] Crear test unitario de guards (AAA) en `frontend/src/app/modules/ventas-crm/guards/*.spec.ts`
- [X] T055 [P] [US7] Implementar `ProspectoApiService` en `frontend/src/app/modules/ventas-crm/services/prospecto-api.service.ts`
- [X] T056 [P] [US7] Crear test unitario del servicio API (AAA) en `frontend/src/app/modules/ventas-crm/services/prospecto-api.service.spec.ts`
- [X] T057 [P] [US7] Implementar `PipelineApiService` + `ConversionApiService` en `frontend/src/app/modules/ventas-crm/services/`
- [X] T058 [P] [US7] Crear tests unitarios (AAA) de `pipeline-api.service.spec.ts` y `conversion-api.service.spec.ts`
- [X] T059 [US7] Página registro público `frontend/src/app/modules/ventas-crm/pages/registro-publico/` (estados loading/error)
- [X] T060 [US7] Página listado `frontend/src/app/modules/ventas-crm/pages/listado-prospectos/` (skeleton/vacío/error)
- [X] T061 [US7] Página detalle + acciones pipeline/asignación `frontend/src/app/modules/ventas-crm/pages/detalle-prospecto/`
- [X] T062 [US7] Board/pipeline UI `frontend/src/app/modules/ventas-crm/pages/pipeline-board/` con manejo 409 reintento
- [X] T063 [US7] Página entrada directa Admin `frontend/src/app/modules/ventas-crm/pages/entrada-directa/`
- [X] T064 [US7] Completar rutas lazy y navegación en `frontend/src/app/modules/ventas-crm/ventas-crm.routes.ts`
...
- [X] T067 Validar escenarios de `quickstart.md` contra API local; anotar resultados en `specs/003-operational/Ventas-CRM/commercial-pipeline-prospects/quickstart.md` (checklist Done when)
...
- [X] T071 [P] Extender DTOs TypeScript `PlanPublico` / envelope en `frontend/src/app/modules/ventas-crm/models/prospectos.types.ts` (o `planes.types.ts`) desde `contracts/commercial-pipeline-prospects.openapi.yaml`
...
- [X] T079 [P] [US8] Implementar `PlanesApiService` en `frontend/src/app/modules/ventas-crm/services/planes-api.service.ts`
- [X] T080 [P] [US8] Crear test unitario (AAA) en `frontend/src/app/modules/ventas-crm/services/planes-api.service.spec.ts`
- [X] T081 [US8] Página `frontend/src/app/modules/ventas-crm/pages/catalogo-planes/` (loading / vacío accionable → registro / error con reintento; CTA a registro público)
- [X] T082 [US8] Registrar ruta **pública** del catálogo (sin guard JWT) en `frontend/src/app/modules/ventas-crm/ventas-crm.routes.ts` y/o `frontend/src/app/app.routes.ts` según patrón de registro-publico
...
- [X] T084 Actualizar checklist / resultados en `specs/003-operational/Ventas-CRM/commercial-pipeline-prospects/quickstart.md` (Done when RF-CPP-000)
