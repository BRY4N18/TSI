...
**Branch**: `commercial-pipeline-prospects` | **Date**: 2026-07-25 (rev. 2026-07-26 RF-CPP-000) | **Spec**: `specs/003-operational/Ventas-CRM/commercial-pipeline-prospects/spec.md`

**Input**: Feature specification from `specs/003-operational/Ventas-CRM/commercial-pipeline-prospects/spec.md` (clarificaciones Session 2026-07-25 + Session 2026-07-26 portal público de planes / RF-CPP-000).
...
```text
specs/003-operational/Ventas-CRM/commercial-pipeline-prospects/
├── plan.md
├── research.md
├── data-model.md
├── quickstart.md
