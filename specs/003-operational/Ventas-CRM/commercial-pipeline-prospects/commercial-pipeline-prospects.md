# Modulo: Pipeline Comercial y Prospectos

**Ubicacion:** `specs/003-operational/Ventas-CRM/commercial-pipeline-prospects/`
...
3. Cambiar `.specify/feature.json` → `…/commercial-pipeline-prospects/backend` o `…/frontend` segun la capa en curso.

## Convencion de nombres

El archivo de indice del modulo se llama **igual que la carpeta del modulo** (`commercial-pipeline-prospects.md`), no `README.md`.
