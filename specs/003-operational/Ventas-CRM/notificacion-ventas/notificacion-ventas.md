# Modulo: Notificacion de Ventas

**Ubicacion:** `specs/003-operational/Ventas-CRM/notificacion-ventas/`
...
3. Cambiar `.specify/feature.json` → `…/notificacion-ventas/backend` o `…/frontend` segun la capa en curso.

## Convencion de nombres

El archivo de indice del modulo se llama **igual que la carpeta del modulo** (`notificacion-ventas.md`), no `README.md`.
