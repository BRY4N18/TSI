...
**Input**: Design documents from `specs/003-operational/Ventas-CRM/notificacion-ventas/backend/`
...
- [X] T001 [Histórico-UI] Extender estructura de tests/páginas según `plan.md`: asegurar dirs `backend/apps/ventas_crm/tests/{api,services,repositories,unit}/`, `frontend/src/app/modules/ventas-crm/{pages/demo-interactiva,pages/notificaciones-ventas,interceptors,services}`
...
- [X] T005 [Bridge-FE] [P] Generar DTOs TypeScript desde OpenAPI en `frontend/src/app/modules/ventas-crm/models/notificacion-ventas.types.ts` basados en `contracts/notificacion-ventas.openapi.yaml`
...
- [X] T007 Validar contrato OpenAPI como gate en `specs/003-operational/Ventas-CRM/notificacion-ventas/backend/contracts/notificacion-ventas.openapi.yaml`
...
- [X] T047 [Histórico-UI] [P] [US5] Implementar `DemoSessionInterceptor` en `frontend/src/app/modules/ventas-crm/interceptors/demo-session.interceptor.ts`
- [X] T048 [Histórico-UI] [P] [US5] Crear test unitario (AAA) en `frontend/src/app/modules/ventas-crm/interceptors/demo-session.interceptor.spec.ts`
- [X] T049 [Histórico-UI] [P] [US5] Implementar `DemoApiService` en `frontend/src/app/modules/ventas-crm/services/demo-api.service.ts`
- [X] T050 [Histórico-UI] [P] [US5] Crear test unitario (AAA) en `frontend/src/app/modules/ventas-crm/services/demo-api.service.spec.ts`
- [X] T051 [Histórico-UI] [P] [US5] Implementar `NotificacionApiService` en `frontend/src/app/modules/ventas-crm/services/notificacion-api.service.ts`
- [X] T052 [Histórico-UI] [P] [US5] Crear test unitario (AAA) en `frontend/src/app/modules/ventas-crm/services/notificacion-api.service.spec.ts`
- [X] T053 [Histórico-UI] [US5] Página demo interactiva `frontend/src/app/modules/ventas-crm/pages/demo-interactiva/` (grant → sesión → eventos; estados error)
- [X] T054 [Histórico-UI] [US5] Página notificaciones `frontend/src/app/modules/ventas-crm/pages/notificaciones-ventas/` (skeleton / vacío accionable / error+retry)
- [X] T055 [Histórico-UI] [US5] Completar rutas lazy demo + notificaciones en `frontend/src/app/modules/ventas-crm/ventas-crm.routes.ts` (reutilizar `admin-o-gerente-crm.guard.ts`)
...
- [X] T058 Validar escenarios de `quickstart.md` contra API local; anotar checklist Done when en `specs/003-operational/Ventas-CRM/notificacion-ventas/backend/quickstart.md`
