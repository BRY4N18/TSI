...
**Input**: Design documents from `specs/003-operational/Suscripciones-Facturacion/subscriptions-and-billing/`
...
- [X] T001 Crear estructura de carpetas en `backend/apps/suscripciones/{views,services,services/pasarela,jobs,tests/{api,services,jobs,repositories,unit}}`, `backend/core/repositories/suscripciones/` y `frontend/src/app/modules/suscripciones/{pages,services,guards,services/models}`
...
- [X] T005 [P] Generar tipos TypeScript stub en `frontend/src/app/modules/suscripciones/services/models/suscripciones.types.ts` desde `contracts/subscriptions-and-billing.openapi.yaml`
- [X] T006 [P] Crear módulo Angular lazy stub `frontend/src/app/modules/suscripciones/suscripciones.routes.ts` y registrar en `frontend/src/app/app.routes.ts`
...
- [X] T007 Validar contrato OpenAPI como gate en `specs/003-operational/Suscripciones-Facturacion/subscriptions-and-billing/contracts/subscriptions-and-billing.openapi.yaml`
...
**Goal**: Admin gestiona `Dim_Plan` (RF-001); Proveedor contrata suscripción inicial (RF-010) con sync `plan_suscripcion` y ciclo Guayaquil.
...
**Independent Test**: Guard admin bloquea Proveedor en catálogo; historial muestra vacío/carga; mi-suscripción refleja `acceso_permitido`.

**Measurable Criteria**: RNF-SUSF-006; quickstart UI smoke.

### Tests for User Story 8

- [X] T073 [P] [US8] Crear tests Jasmine (AAA) de `SuscripcionApiService` en `frontend/src/app/modules/suscripciones/services/suscripcion-api.service.spec.ts`
- [X] T074 [P] [US8] Crear tests Jasmine (AAA) de guards en `frontend/src/app/modules/suscripciones/guards/proveedor-billing.guard.spec.ts` y `admin-billing.guard.spec.ts`

### Implementation for User Story 8

- [X] T075 [P] [US8] Completar tipos desde OpenAPI en `frontend/src/app/modules/suscripciones/services/models/suscripciones.types.ts`
- [X] T076 [P] [US8] Implementar `suscripcion-api.service.ts`, `plan-api.service.ts`, `metodo-pago-api.service.ts`, `factura-api.service.ts` en `frontend/src/app/modules/suscripciones/services/`
- [X] T077 [US8] Implementar `proveedor-billing.guard.ts` y `admin-billing.guard.ts` en `frontend/src/app/modules/suscripciones/guards/`
- [X] T078 [US8] Implementar pages stub funcionales `mi-suscripcion`, `metodos-pago`, `historial-facturas`, `cambio-plan`, `catalogo-planes`, `aprobaciones-downgrade` bajo `frontend/src/app/modules/suscripciones/pages/`
- [X] T079 [US8] Cablear rutas lazy con guards en `frontend/src/app/modules/suscripciones/suscripciones.routes.ts`
...
- [X] T083 [P] Actualizar `specs/003-operational/Suscripciones-Facturacion/subscriptions-and-billing/quickstart.md` con comandos reales de management/pytest marcados
