# Modulo: Suscripciones y Facturacion

**Ubicacion:** `specs/003-operational/Suscripciones-Facturacion/subscriptions-and-billing/`
**Departamento:** Suscripciones-Facturacion
...
3. Cambiar `.specify/feature.json` → `…/subscriptions-and-billing/backend` o `…/frontend` segun la capa en curso.

## Convencion de nombres

El archivo de indice del modulo se llama **igual que la carpeta del modulo** (`subscriptions-and-billing.md`), no `README.md`.
