...
> **Indice del modulo:** [`../gestion-cuentas.md`](../gestion-cuentas.md).
> **UI (Interaction Capability):** [`../frontend/spec.md`](../frontend/spec.md) — stub Fase A; no duplicar OpenAPI/data-model en FE.


**Branch**: `003-operational-cuentas-clientes-gestion-cuentas` | **Date**: 2026-07-09 | **Spec**: `specs/003-operational/Cuentas-Clientes/gestion-cuentas/backend/spec.md`

**Input**: Feature specification from `specs/003-operational/Cuentas-Clientes/gestion-cuentas/backend/spec.md`
...
```text
specs/003-operational/Cuentas-Clientes/gestion-cuentas/backend/
├── plan.md
├── research.md
├── data-model.md
├── quickstart.md
