# Modulo: Gestion de Cuentas

**Ubicacion:** `specs/003-operational/Cuentas-Clientes/gestion-cuentas/`
...
3. Cambiar `.specify/feature.json` → `…/gestion-cuentas/backend` o `…/frontend` segun la capa en curso.

## Convencion de nombres

El archivo de indice del modulo se llama **igual que la carpeta del modulo** (`gestion-cuentas.md`), no `README.md`.
