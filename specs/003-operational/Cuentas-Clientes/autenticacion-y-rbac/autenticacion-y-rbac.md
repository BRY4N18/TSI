# Modulo: Autenticacion y RBAC

**Ubicacion:** `specs/003-operational/Cuentas-Clientes/autenticacion-y-rbac/`
...
3. Cambiar `.specify/feature.json` → `…/autenticacion-y-rbac/backend` o `…/frontend` segun la capa en curso.

## Convencion de nombres

El archivo de indice del modulo se llama **igual que la carpeta del modulo** (`autenticacion-y-rbac.md`), no `README.md`.
