# Modulo: Incorporacion de Clientes

**Ubicacion:** `specs/003-operational/Cuentas-Clientes/incorporacion-clientes/`
**Departamento:** Cuentas-Clientes
...
3. Cambiar `.specify/feature.json` → `…/incorporacion-clientes/backend` o `…/frontend` segun la capa en curso.

## Convencion de nombres

El archivo de indice del modulo se llama **igual que la carpeta del modulo** (`incorporacion-clientes.md`), no `README.md`.
