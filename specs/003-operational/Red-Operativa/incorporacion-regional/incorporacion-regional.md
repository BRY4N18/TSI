# Modulo: Incorporacion Regional

**Ubicacion:** `specs/003-operational/Red-Operativa/incorporacion-regional/`
...
3. Cambiar `.specify/feature.json` → `…/incorporacion-regional/backend` o `…/frontend` segun la capa en curso.

## Convencion de nombres

El archivo de indice del modulo se llama **igual que la carpeta del modulo** (`incorporacion-regional.md`), no `README.md`.
