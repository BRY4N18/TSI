...
**Ubicación:** `specs/002-tactico/Emergencias/informes-tacticos-agregados/`
...
3. Cambiar `.specify/feature.json` → `…/informes-tacticos-agregados/backend` o `…/frontend` según la capa en curso.
...
El archivo de índice del módulo se llama **igual que la carpeta del módulo** (`informes-tacticos-agregados.md`), no `README.md`.
