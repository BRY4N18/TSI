...
**Branch**: `informes-tacticos-agregados` | **Date**: 2026-08-01 | **Spec**: `specs/002-tactico/Emergencias/informes-tacticos-agregados/backend/spec.md`

**Input**: Feature specification from `specs/002-tactico/Emergencias/informes-tacticos-agregados/backend/spec.md`
**Capa hermana (UI):** `../frontend/` — ver [`../informes-tacticos-agregados.md`](../informes-tacticos-agregados.md).
...
```text
specs/002-tactico/Emergencias/informes-tacticos-agregados/
├── informes-tacticos-agregados.md   # índice del módulo
...
│   ├── quickstart.md
│   ├── contracts/
│   │   └── informes-tacticos-agregados.openapi.yaml
