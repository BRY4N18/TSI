...
**Input**: Design documents from `specs/002-tactico/Emergencias/informes-tacticos-agregados/frontend/`
...
- [X] T004 Implementar `frontend/src/app/modules/emergencias/services/informes-tacticos-api.service.ts` con los 16 métodos (uno por endpoint de `../backend/contracts/informes-tacticos-agregados.openapi.yaml`)
...
- [X] T018 Actualizar `../informes-tacticos-agregados.md` (índice del módulo) marcando frontend como completo
