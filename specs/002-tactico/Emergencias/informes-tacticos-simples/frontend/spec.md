...
**Feature Branch / capa**: `informes-tacticos-simples/frontend`
...
Ninguna todavía — este stub se completa con `/speckit-clarify` y `/speckit-plan` una vez el backend esté implementado, siguiendo el orden de trabajo documentado en `../informes-tacticos-simples.md`.
...
**Traceability**: Índice del módulo `../informes-tacticos-simples.md` en la carpeta padre.
