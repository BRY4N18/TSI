...
Repetir el paso 1 (con sus parámetros propios) para cada uno de los 16 informes listados en `contracts/informes-tacticos-simples.openapi.yaml`, confirmando `200` y una forma de `data` acorde al esquema documentado ahí.
