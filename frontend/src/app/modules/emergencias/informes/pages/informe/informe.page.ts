/**
 * Una sola página para los cinco listados simples de Emergencias.
 *
...
import { INFORMES_EMERGENCIAS } from '../../definiciones/informes-emergencias.definiciones';
...
@Component({
  selector: 'app-informe-emergencias',
  standalone: true,
  imports: [
    RouterLink,
    TablerIconComponent,
  ...
  template: `
    <section [class]="shellClass">
      <a
        routerLink="/emergencias/informes-simples"
...
export class InformeEmergenciasPage implements OnInit {
  ...
  readonly definicion = computed(() => {
    ...
    const definicion = INFORMES_EMERGENCIAS[id];
    if (!definicion) {
