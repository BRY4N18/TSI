/**
 * Índice de los informes tácticos de Ventas y CRM.
 *
...
import { INFORMES_VENTAS } from '../../definiciones/informes-ventas.definiciones';
import { listadosVisiblesPara } from '../../guards/informes-ventas-crm.guard';
import { AuthApiService } from '../../../../cuentas-clientes/auth/services/auth-api.service';
import { TablerIconComponent } from '../../../../../shared/ui/icon/tabler-icon.component';
import { LIST_PAGE_SHELL_CLASS } from '../../../../../shared/ui/list-states/list-table.styles';

@Component({
  selector: 'app-indice-informes-ventas-crm',
  standalone: true,
    ...
    <section [class]="shellClass">
      ...
      <ul class="grid gap-3 md:grid-cols-2" data-testid="indice-informes">
        @for (informe of visibles(); track informe.id) {
          <li>
            <a
              [routerLink]="['/ventas-crm/informes', informe.id]"
...
export class IndiceInformesVentasPage {
  ...
  readonly visibles = computed(() => {
    ...
    return Object.entries(INFORMES_VENTAS)
