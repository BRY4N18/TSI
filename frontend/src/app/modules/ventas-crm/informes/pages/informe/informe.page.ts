/**
 * Una sola página para los listados tácticos de Ventas y CRM.
 *
...
@Component({
  selector: 'app-informe-ventas-crm',
  standalone: true,
  imports: [
    RouterLink,
    TablerIconComponent,
  ...
  template: `
    <section [class]="shellClass">
      <a
        routerLink="/ventas-crm/informes"
...
export class InformeVentasPage implements OnInit {
  ...
  readonly definicion = computed(() => {
    ...
    const definicion = INFORMES_VENTAS[id];
    if (!definicion) {
