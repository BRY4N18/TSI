/**
 * Una sola página para los dos listados de Soporte.
 *
...
import { INFORMES_SOPORTE } from '../../definiciones/informes-soporte.definiciones';
...
@Component({
  ...
  template: `
    <section [class]="shellClass">
      <a
        routerLink="/soporte-cliente/informes"
...
export class InformeSoportePage implements OnInit {
  ...
  readonly definicion = computed(() => {
    ...
    const definicion = INFORMES_SOPORTE[id];
    if (!definicion) {
