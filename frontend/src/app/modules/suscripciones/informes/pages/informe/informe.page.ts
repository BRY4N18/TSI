/**
 * Una sola página para los listados tácticos de Suscripciones.
 *
...
@Component({
  selector: 'app-informe-suscripciones',
  standalone: true,
  imports: [
    RouterLink,
    TablerIconComponent,
  ...
  template: `
    <section [class]="shellClass">
      <a
        routerLink="/suscripciones/informes"
...
export class InformeSuscripcionesPage implements OnInit {
  ...
  readonly definicion = computed(() => {
    ...
    const definicion = INFORMES_SUSCRIPCIONES[id];
    if (!definicion) {
