/** Tipos de pantalla oe4. Las cifras viven en el backend. */

export type IdPantalla = 'calidad' | 'concentracion' | 'impacto' | 'cobertura';
...
export interface MetaInforme {
  ...
  objetivo?: { cumple?: boolean | null; tipo?: string; valor?: unknown } | null;
...
export function cumpleDe(meta: MetaInforme): boolean | null {
  const valor = meta.objetivo?.cumple;
