...
import { EnvelopeInforme, PeriodoVista } from '../models/informes-oe4.types';

@Injectable({ providedIn: 'root' })
export class InformesOe4ApiService {
  private readonly http = inject(HttpClient);
  private readonly base = '/api/v1/informes-estrategicos/oe4';
