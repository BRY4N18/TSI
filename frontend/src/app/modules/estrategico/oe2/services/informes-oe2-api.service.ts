...
import { EnvelopeInforme, PeriodoVista } from '../models/informes-oe2.types';

@Injectable({ providedIn: 'root' })
export class InformesOe2ApiService {
  private readonly http = inject(HttpClient);
  private readonly base = '/api/v1/informes-estrategicos/oe2';
