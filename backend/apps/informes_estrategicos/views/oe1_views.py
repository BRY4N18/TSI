"""Vista parametrizada de los diez informes publicados de OE1."""
...
from apps.informes_estrategicos.permissions import Oe1Permission
...
class Oe1View(APIView):
    """`GET /informes-estrategicos/oe1/<informe>`."""

    permission_classes = [IsAuthenticated401, Oe1Permission]
