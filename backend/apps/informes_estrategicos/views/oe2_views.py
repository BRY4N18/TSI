"""Vista parametrizada de los diez informes publicados de OE2."""
...
from apps.informes_estrategicos.permissions import Oe2Permission
...
class Oe2View(APIView):
    """`GET /informes-estrategicos/oe2/<informe>`."""

    permission_classes = [IsAuthenticated401, Oe2Permission]
