"""DAG: hecho_suscripcion — instantánea acumulada del dominio financiero."""
...
from lib.hecho_suscripcion_tasks import extract, load, transform

DAG_ID = "modelo_hecho_suscripcion"

with DAG(
    dag_id=DAG_ID,
    description=(
        "Carga hecho_suscripcion (instantánea acumulada, grano una suscripción) "
